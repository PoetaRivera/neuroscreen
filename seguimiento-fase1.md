...
### Commits recientes (2026-05-17)
- `f6e8e1d` — **Actualiza seguimiento con avances 2026-05-17**
- `96f9b0d` — **Migra TDAH al ASRS-5** (Kessler 2005, Ustun 2017, DSM-5)
- `706e6cd` — **Migra DAT al algoritmo real de Olson et al. (2021, PNAS)**
- `cb1f876` — **Auditoría científica completa de los 20 tests**
...
| 2 | TEA Adulto (AQ-50) | `tea-adult-v1` | Likert | 50 ítems | `calculateTeaScore` |
| 3 | Alta Sensibilidad (HSPS-27) | `hsp-adult-v1` | Likert | 27 ítems | `calculateHspScore` |
| 4 | Alexitimia (TAS-20) | `alexitimia-adult-v1` | Likert | 20 ítems | `calculateAlexithymiaScore` |
...
| 9 | Fluencia Verbal (COWAT/FAS) | `fas-v1` | Tarea | 3 × 60s (F,A,S) | `calculateFasScore` |
...
| 17 | Test Textual de Estados Mentales | `rmet` | Tarea | 24 estímulos | `calculateRmetScore` |
...
13. **RMET** renombrado a Test Textual de Estados Mentales (2026-05-17). Se aclara que es adaptación textual inspirada en Baron-Cohen et al. (2001), no el RMET fotográfico validado. Scoring extraído a `rmetScoring.js` con 13 tests unitarios. Disclaimer y fuente visibles en UI.
